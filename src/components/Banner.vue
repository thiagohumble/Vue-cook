<template>
  <header class="banner">
    <div class="apresentacao"><img src="../assets/images/logo.svg" alt="Logo de cookingup" class="logo">
      ...
      <img src="../assets/images/foto-banner.png" alt="Foto de uma mulher" class="foto.banner">
  </header>
</template>
